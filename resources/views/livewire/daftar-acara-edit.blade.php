<div class="container-fluid px-4">
    <h1 class="mt-4">Kemaskini Daftar Acara</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">KemaskiniDaftar Acara</li>
    </ol>
    <div class="row">
        <div class="col-md-8">
            <div class="card mb-4">
                <div class="card-body">
                    <form class="needs-validation" novalidate wire:submit.prevent="simpanAcara">
                        ...
                        <div class="mb-3 has-validation">
                            ...
                            <input type="text" class="form-control" id="slug" wire:model="slug" required readonly>
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                <div class="card-body">
                    <h5>Nota:</h5>
                    <p class="card-text">Sila lengkapi semua maklumat yang bertanda (*) sebelum mengemaskini acara.</p>
                </div>
            </div>
        </div>
    </div>
